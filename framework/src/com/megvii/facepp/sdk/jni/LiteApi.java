...
public class LiteApi {
    ...
    public static native int nativeCompare(
            long j, byte[] bArr, int i, int i2, int i3, boolean z, boolean z2, int[] iArr);

    public static native int nativeCompareFeatures(
            long j, byte[] bArr, float[] fArr, int i, boolean z);

    public static native int nativeCompareMultiImages(
            long j, Lite.MGULKImage[] mGULKImageArr, int[] iArr);
    ...
    public static native int nativeGetFeature(
            long j, byte[] bArr, int i, int i2, int i3, byte[] bArr2);
    ...
    public static native int nativeSaveFeature(
            long j,
            byte[] bArr,
            int i,
            int i2,
    ...
    public static native int nativeSaveFeatureMultiImages(
            long j, Lite.MGULKImage[] mGULKImageArr, byte[] bArr, byte[] bArr2, int[] iArr);

    public static native int nativeSetConfig(
            long j, float f, float f2, float f3, float f4, boolean z, boolean z2);
    ...
    public static native int nativeUpdateFeature(
            long j, byte[] bArr, int i, int i2, int i3, int i4, byte[] bArr2, byte[] bArr3, int i5);
